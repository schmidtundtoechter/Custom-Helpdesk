"""
HD Agent Support Report.

Shows hours and billing amounts per HD Agent, per support category (Preiskategorie),
per month. Used by management to analyse agent workload and category breakdown.

Filters: From Date, To Date, HD Agent (optional).
