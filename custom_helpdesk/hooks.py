...
fixtures = [
    {
        ...
        "filters": [
            ["name", "in", [
                ...
                "HD Ticket-abschluss_section",
                "HD Ticket-zeiteintraege_vollstaendig",
                "HD Ticket-kunde_benachrichtigt",
                "HD Ticket-klassifizierung",
                "HD Ticket-schliessungsstatus",
                "HD Ticket-schliessungs_kommentar",
                "HD Ticket-schliessungs_kommentar_intern",
            ]],
        ],
    },
    {
